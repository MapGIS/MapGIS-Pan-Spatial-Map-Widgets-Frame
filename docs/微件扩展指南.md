...
在 mapgis-pan-spatial-map-widgets-frame 的 src/widgets 目录下新建目录文件 widget-example，作为扩展微件专属目录。如果已有可使用分类目录，可省略该步骤。

![](./images/%E6%96%B0%E5%BB%BA%E6%89%A9%E5%B1%95%E5%BE%AE%E4%BB%B6%E6%96%87%E4%BB%B6%E5%A4%B9.png)

## 新增微件

在 src/widgets/widget-example 文件夹下新建 widget-example.vue 文件夹
...
3.在 src/widgets/widget-example 文件夹下新建 index.js 文件用于导出微件

![](./images/%E5%AF%BC%E5%87%BA%E5%BE%AE%E4%BB%B6.png)

4.在 src/widgets/index.js 文件中注册微件
